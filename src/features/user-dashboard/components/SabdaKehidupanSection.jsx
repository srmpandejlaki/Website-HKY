  ...
  return (
    <section className="sabda-kehidupan-section">
      ...
      <p className="text">
        ...
        <br /><br />
        Yesus dengan tegas memilih bersandar penuh pada kasih Allah dan menyerahkan diri seutuhnya pada kehendak BapaNya, daripada memuaskan kemauanNya sendiri dengan menyalahgunakan semua kewenangan yang ada padaNya.
        Sesungguhnya Yesus sanggup melakukan semua yang diminta Iblis, tapi Ia memilih untuk solider dengan kita manusia yang lemah dan rapuh, daripada hidup sebagai manusia super yang bebas dari kerja keras serta susah dan derita.
        <br /><br />
        Yesus memilih untuk ikut bersusah payah bekerja bersama kita, memikul beban kehidupan, ikut sakit dan terluka, daripada berjalan sendiri tanpa rintangan. Yesus tak pernah mau terlepas dari cinta BapaNya, sekalipun salib, sengsara dan kematian menjadi konsekwensinya.
...
export default SabdaKehidupanSection;