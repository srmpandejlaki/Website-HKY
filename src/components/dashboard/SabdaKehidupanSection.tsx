/**
 * Komponen SabdaKehidupanSection
 * Menampilkan ringkasan Sabda Kehidupan di halaman Dashboard (hero section).
 *
  ...
  return (
    <section className="sabda-kehidupan-section">
      ...
      <p className="text">
        ...
        Putra Allah untuk memuaskan dorongan hawa nafsu dalam diriNya. Godaan
        pertama, memilih jalan pintas dan instan dengan merubah batu menjadi
        roti demi mengatasi rasa laparNya. Ke dua, Yesus digoda untuk
        menunjukkan betapa hebatnya Dia sehingga tak pernah akan celaka dan
        terantuk pada apapun. Ke tiga, godaan menjadi penguasa dunia dan
        memiliki semua kerajaan di dunia ini.
        <br />
        <br />
        Yesus dengan tegas memilih bersandar penuh pada kasih Allah dan
        menyerahkan diri seutuhnya pada kehendak BapaNya, daripada memuaskan
        kemauanNya sendiri dengan menyalahgunakan semua kewenangan yang ada
        padaNya. Sesungguhnya Yesus sanggup melakukan semua yang diminta Iblis,
