      ...
      <div className="contact-main">
        <div className="contact-number">
          ...
          <ul>
            ...
            <li>
              Address: Jl. Raya Tomohon, Kolongan, Kec. Tomohon Tengah, Kota
        ...
        <div className="contact-medsos">
          ...
          <ul>
            <li>
              <a
                href="https://www.facebook.com/parokihatiKudusYesus"
                target="_blank"
            ...
            <li>
              <a
                href="https://www.instagram.com/parokihatiKudusYesus"
                target="_blank"
                rel="noopener noreferrer"
              >
                Instagram
